$(document).ready(function() {
  var stateData = {
    AL: { fullName: 'Alabama',
          ...
          source: '<div class="sources"><p><strong>More data:</strong><br/><a href="2019-report">Read the 2019 Energy Employment by State report</a></p><p><strong>Need more information?</strong><br/><a href="mailto:info@energyfuturesinitiative.org">Contact us for additional analysis and reports</a></p></div>'
    },
    AK: { fullName: 'Alaska',
